...
const COMPOUNDS: Dictionary = {
	...
	"hydrochloric_acid": {
		"name": "Hydrochloric Acid", "formula": "HCl", "tier": 2,
	...
	"potassium_oxide": {
		"name": "Potassium Oxide", "formula": "K₂O", "tier": 3,
		"type": "Metal Oxide", "state": "Solid",
	...
	"methane": {
		"name": "Methane", "formula": "CH₄", "tier": 2,
...
const COMPOUNDS3: Dictionary = {
	"acetic_acid": {
		"name": "Acetic Acid", "formula": "CH₃COOH", "tier": 4,
	...
	"iron_sulfate": {
		"name": "Iron(II) Sulfate", "formula": "FeSO₄", "tier": 4,
	...
	"calcium_carbonate_pure": {
		"name": "Calcium Carbonate (Pure)", "formula": "CaCO₃★", "tier": 4,
	...
	"copper_sulfate": {
		"name": "Copper(II) Sulfate", "formula": "CuSO₄", "tier": 4,
		"type": "Inorganic Salt", "state": "Solid",
	...
	"nitric_acid": {
		"name": "Nitric Acid", "formula": "HNO₃", "tier": 4,
		"type": "Strong Acid", "state": "Liquid",
	...
	"sulfuric_acid": {
		"name": "Sulfuric Acid", "formula": "H₂SO₄", "tier": 5,
		"type": "Strong Acid", "state": "Liquid",
	...
	"potassium_nitrate": {
		"name": "Potassium Nitrate", "formula": "KNO₃", "tier": 5,
		"type": "Inorganic Salt", "state": "Solid",
