...
const QUESTS := {
	...
	Tab.WEEKLY: [
		...
		{"id": "w_battle5", "label": "ต่อสู้ 5 ครั้งในสัปดาห์",      "desc": "เข้าร่วมการต่อสู้ใดก็ได้",  "current": 0, "total": 5,  "go": "battle",    "exp": 250, "gold": 2500, "crystal": 100},
	...
	Tab.CHALLENGE: [
		...
		{"id": "ch_5star", "label": "รับตัวละคร 5★ จากกาชา", "desc": "สุ่มจนได้ตัวละคร 5 ดาว", "current": 0, "total": 1,  "go": "gacha",  "exp": 500, "gold": 5000, "crystal": 200},
		{"id": "ch_elem",  "label": "ทำปฏิกิริยา 10 ครั้ง",   "desc": "ใช้ธาตุผสมกันในการต่อสู้", "current": 0, "total": 10, "go": "battle", "exp": 250, "gold": 2500, "crystal": 100},
	],
}
