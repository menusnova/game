	...
	"Lyra": {
		...
		"skills": [
			{"name": "Void Strike",   "type": "Basic ATK", "img": "res://image/lyra_2.png",
			 ...
			 "desc_short": "โจมตี 1 เป้าหมาย 24 DMG (รวม Passive = 28.8)",
			...
			{"name": "Null Barrier",  "type": "Defend",    "img": "res://image/lyra_1.png",
			 ...
			 "desc_short": "ลดดาเมจที่รับ 50% ไม่เสียเทิร์น",
			...
			{"name": "Aether Pulse",  "type": "Skill",     "img": "res://image/lyra_3.png",
			 ...
			 "desc_short": "ฟื้น HP 15% + สร้าง Void Shield",
			...
			{"name": "Absolute Zero Formula", "type": "Ultimate", "img": "res://image/lyra_2.png",
			 ...
			 "desc_short": "55 DMG ทุกตัว + ลด ATK ศัตรู 30%",
		...
		"passive": {
			...
			"desc_short": "โจมตีทุกครั้งเพิ่มดาเมจ 20% ตลอดเวลา",
